...
# Desde otro contenedor de la red Docker de WoTtrader:
# http://wottrader1:3000
#
...
def create_summary_agent() -> AssistantAgent:
    return AssistantAgent(
        ...
        output_content_type=GeneratedDeviceSummary,
...
def create_request_interpreter_agent() -> AssistantAgent:
    return AssistantAgent(
        ...
        model_client=ollama_model_client,
        output_content_type=WoTQueryPlan,
        model_client_stream=False,
        system_message="""
...
def create_candidate_selector_agent() -> AssistantAgent:
    return AssistantAgent(
        ...
        model_client=ollama_model_client,
        output_content_type=CandidateSelectionResult,
        model_client_stream=False,
        system_message="""
...
async def generate_summaries() -> DeviceSummaryCatalog:
    """
    Called by WoTtrader to generate a new summary catalog.
    """
    ...
    try:
        ...
        summary_catalog = _build_summary_template(tds)
        snapshot_path = save_td_snapshot(td_payload_obj)
